    ...
    <>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <AnimatedStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3" staggerDelay={80}>
            <a href={`tel:${PHONE}`} className="group flex items-center gap-3.5 bg-dortex-light border border-dortex-border rounded-2xl p-4 hover:border-dortex-cyan/40 hover:shadow-[0_8px_32px_rgba(15,164,181,0.08)] hover:-translate-y-1 transition-all duration-500">
              ...
              <div>
                <span className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray">Phone</span>
            ...
            <a href={`mailto:${EMAIL}`} className="group flex items-center gap-3.5 bg-dortex-light border border-dortex-border rounded-2xl p-4 hover:border-dortex-cyan/40 hover:shadow-[0_8px_32px_rgba(15,164,181,0.08)] hover:-translate-y-1 transition-all duration-500">
              ...
              <div>
                <span className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray">Email</span>
            ...
            <div className="flex items-start gap-3.5 bg-dortex-light border border-dortex-border rounded-2xl p-4">
              ...
              <div>
                <span className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray">Location</span>
            ...
            <div className="flex items-start gap-3.5 bg-dortex-light border border-dortex-border rounded-2xl p-4">
              ...
              <div>
                <span className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray">Business Hours</span>
      ...
      <section className="bg-dortex-light border-y border-dortex-border" style={{ padding: 'clamp(1.5rem, 3vh, 2rem) clamp(1rem, 4vw, 2.5rem)' }}>
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4">
          <span className="font-heading text-[11px] uppercase tracking-wider text-dortex-gray">Follow Dortex India</span>
          <div className="flex items-center gap-3">
            {SOCIAL_LINKS.map((social) => (
              ...
              >
                ...
                <span className="font-heading text-[11px] font-medium tracking-wider">{social.label}</span>
              </a>
            ))}
          </div>
        </div>
            ...
            <AnimatedSection className="lg:w-[42%]">
                ...
                <div className="p-4 bg-white border-t border-dortex-border">
                  <div className="flex flex-col sm:flex-row gap-2.5">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group flex-1 inline-flex items-center justify-center gap-2 font-heading text-[11px] uppercase tracking-wider text-white bg-dortex-cyan rounded-full px-4 py-2.5 hover:bg-[#0A8A99] transition-all"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group flex-1 inline-flex items-center justify-center gap-2 font-heading text-[11px] uppercase tracking-wider text-dortex-cyan border border-dortex-cyan/40 rounded-full px-4 py-2.5 hover:bg-dortex-cyan hover:text-white transition-all"
                    >
              ...
              <div className="flex flex-col sm:flex-row gap-2.5 mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex-1 inline-flex items-center justify-center gap-2 bg-[#25D366] text-white rounded-full px-5 py-3 font-heading text-[12px] font-medium hover:bg-[#1DA851] transition-all hover:shadow-[0_4px_16px_rgba(37,211,102,0.3)]"
                >
                  <MessageCircle size={18} /> Chat on WhatsApp
                </a>
                <a
                  href={`tel:${PHONE}`}
                  className="group flex-1 inline-flex items-center justify-center gap-2 bg-dortex-orange text-white rounded-full px-5 py-3 font-heading text-[12px] font-medium hover:bg-dortex-orange-dark transition-all hover:shadow-[0_4px_16px_rgba(245,154,35,0.3)]"
                >
              ...
              <div className="bg-dortex-light rounded-2xl border border-dortex-border p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <label className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray mb-1">Name *</label>
                    ...
                    <div>
                      <label className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray mb-1">Email *</label>
                  ...
                  <div>
                    <label className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray mb-1">Subject *</label>
                  ...
                  <div>
                    <label className="block font-heading text-[10px] uppercase tracking-wider text-dortex-gray mb-1">Your Message *</label>
                  ...
                  <button type="submit" className="group w-full bg-gradient-to-r from-dortex-cyan to-[#0A8A99] text-white rounded-xl py-3.5 font-heading text-[13px] font-medium uppercase tracking-wider hover:shadow-[0_6px_24px_rgba(15,164,181,0.3)] transition-all flex items-center justify-center gap-2">
